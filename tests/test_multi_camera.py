...
class TestMultiCameraStreaming(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.original_enable_playback = os.environ.get("ENABLE_PLAYBACK")
        os.environ["ENABLE_PLAYBACK"] = "0"
    ...
    def tearDown(self) -> None:
        ...
        if self.original_enable_playback is not None:
            os.environ["ENABLE_PLAYBACK"] = self.original_enable_playback
        else:
            os.environ.pop("ENABLE_PLAYBACK", None)
